  ...
  render () {
    return (
      ...
      <HornedBeats  
        ...
        description={hornedBeastsData[0].description}/>
      <HornedBeats 
         title= {hornedBeastsData[1].title}
         imageUrl= {hornedBeastsData[1].image_url}
         description={hornedBeastsData[1].description}/>
      <HornedBeats 
